...
// `.grok/` is gitignored: the og skill exists in the generation sandbox only.
const NO_OG_SKILL = existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/references"))
  ? ""
  : ".grok/skills/og absent (gitignored, sandbox only)";

test("every hand-over the og skill prints is one this script accepts", (t) => {
  if (NO_OG_SKILL) return t.skip(NO_OG_SKILL);
