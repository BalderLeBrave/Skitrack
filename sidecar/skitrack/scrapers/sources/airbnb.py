...
def normalize_airbnb(raw: dict[str, Any]) -> CanonicalListing:
    """Airbnb GraphQL : bedroomCount / personCapacity, GPS toujours approximatif."""
    listing = normalize(raw, "airbnb_scraper")
