 ...
 * d'animation : la neige est là, elle ne tombe pas.
 */
...
export function Flocons({
  ...
  return (
    <div ref={box} className="hero7__neige" aria-hidden data-testid="home-snow">
      <canvas ref={canvas} className="hero7__neige-toile" />
    </div>
  );
}
