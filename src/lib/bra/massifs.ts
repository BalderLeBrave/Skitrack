...
export const BRA_KEYWORDS: [string, string[]][] = [
  ...
  ["Dévoluy", ["superdevoluy", "super devoluy", "devoluy"]],
  ["Champsaur", ["orcieres", "merlette", "champsaur"]],
  ["Ubaye", ["pra loup", "praloup", "sauze", "ubaye"]],
  ["Haut-Var Haut-Verdon", ["val d allos", "allos", "haut verdon"]],
  ...
  ["Haute-Ariège", ["ax 3 domaines", "ax les thermes", "ariege"]],
  ["Orlu-Saint-Barthélemy", ["ascou", "pailheres", "ascou pailheres", "monts d olmes", "olmes", "orlu"]],
