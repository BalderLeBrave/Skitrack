...
export const CLES: readonly Cle[] = [
  ...
  {
    id: "pyairbnb",
    env: ["SKITRACK_PYAIRBNB_PYTHON"],
    label: "Interpréteur Python du relevé Airbnb",
    sert: "Chemin de l'exécutable Python qui porte le relevé Airbnb.",
    sans: "Le relevé Airbnb tente « python3 ». Si cette commande n'existe pas sur la machine, cette source-là ne rend rien ; les autres sources de logements continuent.",
    obtenir: null,
    secret: false,
