 ...
 * soixante-neuf ; vingt et un en ont un ici : les sept d'Open System, les dix
 * de MSEM, les trois d'Ingénie et celle de Deskline / Feratel. Quinze de ces
 * vingt et un s'interrogent vraiment, et couvrent vingt-quatre stations.
 *
 * Pour les quarante-huit autres centrales, `registre.ts` sait déjà nommer le
