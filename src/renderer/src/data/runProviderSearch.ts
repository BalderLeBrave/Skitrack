...
function toLodging(
  ...
  // Séjour formel seulement. Nuit, semaine d'appel et « à partir de » ne passent pas.
  const comparable = comparableStayTotal(a)
  if (comparable == null) return null
  const total = Math.round(comparable * 100) / 100
