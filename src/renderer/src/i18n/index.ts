...
const CATALOG = {
  ...
  home_sc_high_title: ['Front de neige à 1 800 m ou plus', 'Snow front at 1,800 m or higher'],
  ...
  sort_altitude_min_desc: ['Front de neige (décroissant)', 'Snow front (highest first)'],
