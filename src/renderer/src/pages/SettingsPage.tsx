...
const KEY_LABELS: Record<SecretKey, { label: string; help: string; url?: string }> = {
  ...
  crawlbase_token: {
    label: 'Crawlbase — Booking',
    help:
      'Jeton Crawling API (curl api.crawlbase.com). Premier moteur Booking, sans navigateur. ' +
      'Variable CRAWLBASE_TOKEN en dev.',
    url: 'https://crawlbase.com/docs/crawling-api/'
  },
  scrapingbee_key: {
    label: 'ScrapingBee — Booking',
    help:
      'Clé API ScrapingBee (paquet booking-scraper-api). Relais résidentiels + JS. ' +
      'Variable SCRAPINGBEE_API_KEY en dev.',
    url: 'https://pypi.org/project/booking-scraper-api/'
  },
  meteofrance: {
    label: 'Météo-France',
